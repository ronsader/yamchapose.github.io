// copied from https://github.com/joshwcomeau/Tello/blob/master/src/components/Particle/Particle.js
...
class Particle extends PureComponent {
  ...
  drawDelay =
    typeof this.props.drawDelay === 'number'
      ? this.props.drawDelay
      : random(500, 5000);

  drawSpeed =
    typeof this.props.drawSpeed === 'number'
      ? this.props.drawSpeed
      : random(1000, 4000);

  undrawDelay =
    typeof this.props.undrawDelay === 'number'
